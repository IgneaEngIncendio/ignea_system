...
class StoreProjectRequest extends FormRequest
{
    ...
    {
        return [
            'codigo_interno' => 'required|string|max:50|unique:projects,codigo_interno',
            ...
            'ocupacoes'      => 'nullable|string', // Validated as string because it comes as JSON from frontend
